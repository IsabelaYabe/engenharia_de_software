...
class TestDatabaseManager(unittest.TestCase):
    ...
    def test_create_exist_table(self, mock_connect):
        ...
        mock_cursor.execute.assert_called_once_with("""
                    ...
                    """,
                    ("test_db","test_table"))
        logger.info("Test create exist table: OK!!! ---------------------------> TESTE 11 OK!!!")
    ...
    def test_delete_table(self, mock_connect):
        ...
        logger.info("Test delete table: OK!!! ---------------------------> TESTE 12 OK!!!")
    ...
    def test_insert_row(self, mock_connect, mock_uuid):
        ...
        self.db_manager._insert_row(col0 = "value_0", col_1="value_1", col3= "value_3")

        mock_cursor.execute.assert_called_once_with(expected_sql, tuple(values))
        logger.info("Test delete table: OK!!! ---------------------------> TESTE 13 OK!!!")
    ...
    def test_update_row(self, mock_connect):
        ...
        self.db_manager._update_row(record_id, col0 = "value_0", col_1="value_1", col3= "value_3")

        mock_cursor.execute.assert_any_call(hidden_sql, (record_id,))
        mock_cursor.execute.assert_any_call(expected_sql, tuple(values))
        logger.info("Test update row: OK!!! ---------------------------> TESTE 14 OK!!!")
    ...
    def test_get_by_id(self, mock_connect):
        ...
        return_ = self.db_manager._get_by_id("12345678-1234-5678-1234-567812345678")
    
        mock_cursor.execute.assert_called_once_with(expected_sql, (id,))
        mock_cursor.fetchall.assert_called_once()

        self.assertEqual(return_, fetchall_return)                           
        logger.info("Test get by id: OK!!! ---------------------------> TESTE 15 OK!!!")
    ...
    def test_search_record(self, mock_connect):
        ...
        return_ = self.db_manager._search_record(col1="value1", col2="value2")
    
        mock_cursor.execute.assert_called_once_with(expected_sql, tuple(values))
        mock_cursor.fetchall.assert_called_once()

        self.assertEqual(return_, fetchall_return)                           
        logger.info("Test search record: OK!!! ---------------------------> TESTE 16 OK!!!")
    ...
    def test_execute_sql(self, mock_connect):
        ...
        self.db_manager._execute_sql(expected_sql)

        mock_cursor.execute.assert_called_once_with(expected_sql, None)
                               
        logger.info("Test execute sql: OK!!! ---------------------------> TESTE 17 OK!!!")
